...
class SentenceChunker:
    ...
    def chunk(self, text: str) -> list[str]:
        ...
        # Keep sentence-ending punctuation with the sentence.  Besides normal
        # spaces, newlines are accepted as boundaries so Markdown paragraphs
        # do not accidentally become one very long sentence.
        sentences = [
            sentence.strip()
...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        def flush_pending() -> None:
            if pending:
                merged = separator.join(pending).strip()
                if merged:
        ...
        for piece in current_text.split(separator):
            ...
            candidate = separator.join([*pending, piece]) if pending else piece
        ...
        flush_pending()
        return chunks or self._split(current_text, next_separators)
